export const API_PATHS = {
  ...
  BU:              '/api/bu',
  CONTI:           '/api/conti',
  CONTI_SALDO_INIZIALE: (id: number) => `/api/conti/${id}/saldo-iniziale`,
  CESPITI:         '/api/cespiti',
  ...
  MOVIMENTI: {
    ...
    PARTITE_APERTURA: '/api/movimenti/partite-apertura',
    ASSEGNA_CONTO:    (id: string) => `/api/movimenti/${id}/conto-bancario`,
  },
  DASHBOARD: {
